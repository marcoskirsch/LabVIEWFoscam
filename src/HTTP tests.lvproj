...
<Project Type="Project" LVVersion="13008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Extract data until pattern.vi" Type="VI" URL="../Extract data until pattern.vi"/>
		<Item Name="Extract Image Header.vi" Type="VI" URL="../Extract Image Header.vi"/>
		<Item Name="HTTP tests.vi" Type="VI" URL="../HTTP tests.vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="Open HTTP connection.vi" Type="VI" URL="../Open HTTP connection.vi"/>
		<Item Name="Save image.vi" Type="VI" URL="../Save image.vi"/>
		<Item Name="TCP tests.vi" Type="VI" URL="../TCP tests.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Extract JPEG.vi" Type="VI" URL="../Extract JPEG.vi"/>
		</Item>
